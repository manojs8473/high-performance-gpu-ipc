...
int main() {
    std::cout << "Working IPC Consumer: Starting..." << std::endl;
    ...
    std::cout << "Working IPC Consumer: Device checks passed" << std::endl;
    ...
    std::cout << "Working IPC Consumer: Signaled ready, opening IPC memory handle..." << std::endl;
    ...
    std::cout << "Working IPC Consumer: IPC memory handle opened successfully!" << std::endl;
    ...
    std::cout << "Working IPC Consumer: Starting GPU IPC image processing..." << std::endl;
    ...
    while (true) {
        ...
        if (duration.count() > 1000) {
            std::cout << "Working IPC Consumer processed frame " << lastFrameNumber << " - FPS: " << (frameCount * 1000.0 / duration.count()) << std::endl;
    ...
    std::cout << "Working IPC Consumer: Complete!" << std::endl;
